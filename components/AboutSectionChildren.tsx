    ...
    <div className="">
      ...
      <div className="lg:px-5">
        ...
        <div>
          ...
          <ul className="grid list-inside list-disc grid-cols-2 justify-items-start text-center text-secondary-500/70 md:grid-cols-3 md:px-5 lg:grid-cols-4 lg:px-6">
